    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-md-6">
            <h3 id="H3" className="text-primary text-center">Lista de Tareas</h3>
        ...
        <div className="col-md-6">
            <h3 id="hl" className="text-primary text-center">{
            ...
            <form onSubmit={
              ...
              <button id='btn1'
                type='submit'
                className={
                  modoEdicion ? "btn btn-danger btn-block " : "btn btn-primary btn-block"
                }
              >{
